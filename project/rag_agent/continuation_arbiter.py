...
def judge_continuation(pending_type: str, payload: dict, user_reply: str, llm=None) -> bool:
    ...
    prompt = _ARBITER_PROMPT.format(summary=summary, reply=str(user_reply or "").strip())
    try:
