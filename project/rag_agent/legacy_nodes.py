"""Legacy monolithic node implementation.

New graph construction imports from focused facade modules. This file keeps the
behavior-preserving implementation in one place while callers migrate away from
the historical ``rag_agent.nodes`` import path.
"""
