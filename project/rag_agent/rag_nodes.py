...
def reset_turn_state(state: State):
    """Clear planner task state at turn start.
...
# P4 self-eval weights (safety weighted highest - medical domain)
...
def self_eval(state: State, llm):
    """P4: online self-eval - LLM-as-judge on the final medical answer.
